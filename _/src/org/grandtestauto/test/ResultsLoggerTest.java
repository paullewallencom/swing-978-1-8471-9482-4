...
public class ResultsLoggerTest {
    ...
    public boolean constructorTest() throws IOException {
        ...
        assert Files.contents( resultsFile ).contains( message1 );
        cleanup();
        initWithResultsFile(  false  );
        String message2 = "message2";
        resultsLogger.log( message2, null );
        assert Files.contents( resultsFile ).contains( message2 );
        assert !Files.contents( resultsFile ).contains( message1 );
        cleanup();
    ...
    public boolean logTest() throws Exception {
        ...
        expected.append( Helpers.NL );
        assert Files.contents( resultsFile ).equals( expected.toString() );
        ...
        String logged = Files.contents( resultsFile );
